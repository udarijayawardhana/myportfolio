...
<div class="cursor-ring" aria-hidden="true"></div>`}const c={nav:{logo:"UJ"},hero:{eyebrow:"Available - Internships & Collaborations",name:'Udari<br/><span class="surname">Jayawardhana<span class="accent">.</span></span>',roles:["developer","designer","creative technologist","data enthusiast","problem-solver"],tagline:"<b>Information Technology undergraduate</b> specializing in Data Science - passionate about UI/UX design, web development, and turning data into meaningful stories.",cta:[{text:"View projects",href:"#projects",class:"btn btn-primary"},{text:"Get in touch",href:"#contact",class:"btn btn-ghost"}]},about:{eyebrow:"01 / About",title:"A short <em>introduction</em>.",bio:["I'm an Information Technology undergraduate at <em>University of Sri Jayewardenepura</em>, majoring in IT with a specialization in <em>Data Science</em>. I'm passionate about UI/UX Design, Mobile App Development, Web Development, and Graphic Design, with a strong interest in creating user-centered digital experiences.","Skilled in frontend development (React, HTML/CSS/JS), mobile app development (React Native/Expo), UI/UX design, database management, and digital design. My recent work spans a <em>full-stack marketplace app for USJ students</em>, interactive Power BI dashboards, and UI/UX prototyping.","I'm also a trained Visharad violinist, which brings a unique creative perspective to everything I build. I demonstrate strong communication, teamwork, problem-solving, and leadership through academic projects and extracurricular involvement."],stats:[{num:"5",small:"+",label:"Projects built"},{num:"#54",small:"",label:"District rank (A/L)"},{num:"3",small:"A's",label:"GCE Advanced Level"},{num:"6",small:"+",label:"Certifications"}],availability:"Open to internships &amp; collaborations"},skills:{eyebrow:"02 / Skills",title:"Tools I reach for <em>without thinking</em>.",groups:[{name:"Frontend Development",delay:"",skills:[{name:"HTML / CSS",level:85},{name:"JavaScript",level:75},{name:"React / React Native",level:65},{name:"WordPress",level:70}]},{name:"Design & Visualization",delay:"1",skills:[{name:"Figma / UI/UX",level:80},{name:"Power BI",level:72},{name:"Video Editing",level:70},{name:"Graphics Design",level:72}]},{name:"Data &amp; Programming",delay:"",skills:[{name:"SQL / Databases",level:70},{name:"Python",level:55},{name:"R",level:50}]},{name:"Other Skills",delay:"1",skills:[{name:"Machine Learning (Fundamentals)",level:45},{name:"Big Data (Fundamentals)",level:40},{name:"Project Management",level:55}]}],marqueeItems:["HTML","CSS","JavaScript","SQL","Figma","React Native","WordPress","Python","R","Power BI","UI/UX","Video Editing"]},projects:{eyebrow:"03 / Selected work",title:"A few things I've <em>built</em>.",githubUrl:"#",items:[{num:"01",title:"USJ Marketplace - UX/UI Design & Mobile App Development",desc:"Full-stack e-commerce mobile application with UX/UI design, frontend, and Firebase backend for USJ students. Includes database integration and user-centered design. (Ongoing)",chips:["UI/UX","React Native","Firebase","Full-Stack"],links:[{href:"#",label:"Details",icon:"↗"}],featured:!0},{num:"02",title:"Simple Daily Planner App",desc:"Developed a task management mobile app with calendar integration and data features using React Native.",chips:["React Native","Mobile","JavaScript"],links:[{href:"#",label:"GitHub",icon:"{ }"}],featured:!1},{num:"03",title:"Happy Paws World Website",desc:"Built a multi-page pet shop website with interactive UI, responsive design, and engaging user experience.",chips:["HTML","CSS","JavaScript"],links:[{href:"#",label:"Live",icon:"↗"}],featured:!1},{num:"04",title:"Kiosk for Food Ordering - UX/UI Design",desc:"Designed a modern kiosk UI focusing on usability, visual hierarchy, and user engagement for a food ordering system.",chips:["Figma","UX/UI","Prototyping"],links:[{href:"#",label:"Case Study",icon:"↗"}],featured:!1},{num:"05",title:"Power BI Sales Dashboard",desc:"Created an interactive business intelligence dashboard to analyze and visualize sales data for decision-making.",chips:["Power BI","Data Viz","BI"],links:[{href:"#",label:"View",icon:"↗"}],featured:!1}]},experience:{eyebrow:"04 / Leadership & Experience",title:"Where I've <em>contributed</em> &amp; grown.",items:[{dates:"2025 - Present",role:"AIESEC in University of Sri Jayewardenepura",org:"Leadership & Volunteering",bullets:["Leadership Body 26.27 (Jan-Jul 2026): Content Strategist - Talent Management; led people showcasing & engagement campaigns.","Member 25.26 (Jan-Jul 2025): Graphic Designer - Outgoing Global Volunteer & Jayewardenepura Showcasing Team; designed visuals & magazine articles.","Awards: Leadership Body of the Month (Feb) - TM; Best Graphic Designer Nominee of the Month (April) - JST.","Organizing Committee: Vice President in Marketing - Iftar Local Committee Meeting 2026."]},{dates:"2025",role:"Entre Club, University of Sri Jayewardenepura",org:"Leadership & Volunteering",bullets:["UX/UI Team Task Master 25.26 - oversaw all media & promotional designs and video editing.","Organizing Committee: Finance Team Member - Camelia'25; fundraising and singing items coordinator."]},{dates:"2025",role:"Flair Club, University of Sri Jayewardenepura",org:"Leadership & Volunteering",bullets:["Organizing Committee: IT & Marketing In-charge - GTUNE (Jun-Sep 2025); oversaw all media & promotional design, video editing, and maintained brand consistency."]},{dates:"2024 - 2025",role:"Department of Social Statistics, USJ",org:"Leadership & Volunteering",bullets:["3rd Place - Inter Department Music Competition 2025.","Organizing Committee: Music Item Coordinator - Magazine Lounge'24.","Marketing Team Member - Elevate'25."]},{dates:"2025",role:"University Badminton & School Prefects",org:"Sports & Leadership",bullets:["Representative Volunteer Judge - SMASHES All Island Badminton Championship 2025.","Games Captain - Board of Prefects, Rippon Girls' College (2019)."]}]},achievements:{eyebrow:"05 / Recognition",title:"Things I'm <em>proud</em> of.",highlights:[{num:"#<span>54</span>",caption:"District Rank - GCE Advanced Level",sub:"Achieved 3 A's with a Z-score of 1.9 - District Rank 54, Island Rank 997 from Rippon Girls' College, Galle (2021).",link:{text:"View education →",href:"#education"}},{num:"<span>🎻</span>",caption:"Bhatkande Visharad - Violin & Vocal",sub:"Completed Bhatkande Visharad in Violin (Prathama, Madhyama, Visharad 1 & 2) and Vocal (Prathama, Madhyama) - a rigorous Indian classical music qualification.",link:{text:"View education →",href:"#education"}}],certs:[{icon:"▣",name:"Introduction to Cybersecurity",issuer:"Cisco Networking Academy"},{icon:"◆",name:"Exploring Networking with Cisco Packet Tracer",issuer:"Cisco Networking Academy"},{icon:"●",name:"Python for Beginners",issuer:"CODL, University of Moratuwa"},{icon:"◇",name:"Web Designing for Beginners",issuer:"CODL, University of Moratuwa"}]},education:{eyebrow:"06 / Education",title:"Where I'm <em>studying</em>.",items:[{dates:"2023 - Present",degree:"Bachelor of Information Technology (Hons)",institution:"University of Sri Jayewardenepura",details:"Major in Information Technology specializing in <b>Data Science</b>. Current GPA: <b>3.5</b>. Coursework includes Machine Learning, Big Data, Database Management, and UI/UX Design."},{dates:"2013 - 2021",degree:"GCE Advanced Level - 3 A's",institution:"Rippon Girls' College, Galle",details:"Z-score: <b>1.9</b> · District Rank: <b>54</b> · Island Rank: <b>997</b>"},{dates:"2022",degree:"Advanced Diploma in English",institution:"ICBT Galle Campus",details:"Professional English language certification."},{dates:"2021",degree:"Advanced Diploma in English",institution:"The Beeline English Academy & SDFL (Ministry of Education)",details:"State-level English language diploma program."},{dates:"2020",degree:"Visharadh in Violin",institution:"Erandhathi Lalitha Kalayathanaya (affiliated to Bhathkande Sangit Vidyapith, Lucknow, India)",details:"Completed Prathama, Madhyama, Visharad 1 &amp; 2 in Violin."}]},contact:{eyebrow:"07 / Contact",title:"Let's <em>build</em> something.",rows:[{label:"Email",value:"udarijayawardhana2001@gmail.com",href:"mailto:udarijayawardhana2001@gmail.com"},{label:"Location",value:"Colombo, Sri Lanka",href:"#"},{label:"Calendar",value:"Book a chat",href:"#"},{label:"Phone",value:"+94 76 067 5441",href:"tel:+94760675441"}],socials:[{name:"LinkedIn",sub:"/in/udari-jayawardhana",href:"https://www.linkedin.com/in/udari-jayawardhana-405141288"},{name:"GitHub",sub:"@udarijayawardhana",href:"https://github.com/udarijayawardhana"}],formAction:"https://formspree.io/f/mojzzqnk"},footer:{name:"Udari Jayawardhana",links:[{text:"About",href:"#about"},{text:"Projects",href:"#projects"},{text:"Contact",href:"#contact"}],resumeHref:"resume.pdf"}};function p(){return`<header class="nav" id="nav">
...
</section>`}function w(){const{experience:e}=c,s=e.items.map(a=>{const t=a.bullets.map(i=>`          <li>${i}</li>`).join(`
...
</section>`}function $(){const{achievements:e}=c,s=e.highlights.map((t,i)=>`      <div class="hi-card reveal"${i>0?` data-delay="${i}"`:""} data-hover>
...
</section>`}function S(){const{contact:e}=c,s=e.rows.map(t=>`        <a class="c-row" href="${t.href}" data-hover><span class="lbl">${t.label}</span><span class="val">${t.value}</span></a>`).join(`
...
</section>`}function I(){const{footer:e}=c,s=e.links.map(a=>`<a href="${a.href}" data-hover>${a.text}</a>`).join(`
      `);return`<footer>
